...
export default function DianaWithdraw() {
    ...
    const handleWithdraw = () => {
        ...
        // Logic to process Diana withdrawal
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.title}>Withdraw Diana</Text>
            ...
            <Text style={styles.label}>Network: Diana</Text>
